...
TorpedoSonar . prototype . noiseLevelBearingCorrection = function (noise, bearing) {
	var org = bearing;
	bearing *= 40;
...
var Leader = function (x, y, bearing, speed) {
	vessel . call (this);
	...
	if (bearing !== undefined) this . position . bearing = bearing;
...
var Mark48 = function (cable, name, country) {
	...
	if (name . includes ('Fast')) this . range = 21;
	if (name . includes ('Long Range')) {this . range = 27; this . speeds [5] = this . speeds [4];}
